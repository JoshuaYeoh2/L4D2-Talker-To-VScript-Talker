...
[
...

	{
		...
		then self c1m4escapeTrevorCheckSuccess from:"Trevor" 0
	},

	{
		...
		then self c1m4escapeTrevorCheckFail from:"Trevor" 0
	},
...

	{
		...
		then self c6m3_loss2 from:"Trevor" -0.7
	},

	{
		...
		then self c6m3_loss3 from:"Trevor" 0.3
	},
...

	{
		...
		then self RightfulKiller from:"Trevor" -0.953
	},

	{
		...
		then self KillStealCalledOut from:"Trevor" -1.545
...

	{
		...
		then self ReviveFriendDownFinal from:"Trevor" -0.608
	},

	{
		...
		then self ReviveFriendDownFinal from:"Trevor" -1.447
	},
...

	{
		...
		then self _C1M1_ElevatorHello13a from:"Trevor" -2.554
	},
...

	{
		...
		then self _c2m1_searchlights04 from:"Trevor" 0.1
		ApplyContext "Talk:1:2.662"
		applycontexttoworld
	},
...

	{
		...
		then self _c4m2_seestation03 from:"Trevor" 0.01
		ApplyContext "Talk:1:2"
		applycontexttoworld
	},
...

	{
		...
		then self _C1M1_ElevatorHello3AliveExtra2 from:"Trevor" -1.856
...

	{
		...
		then self _C1M1_ElevatorHello3AliveName2 from:"Trevor" -1.856
		ApplyContext "TrevorIntroduced:1:0"
		applycontexttoworld
	},
...

	{
		...
		then self Player.KnowHunter2 from:"Trevor" 0.1
	},
